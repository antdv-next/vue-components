...
export interface NodeMouseEventParams<TreeDataType extends BasicDataNode = DataNode, T = HTMLElement> {
  event: MouseEvent
  node: EventDataNode<TreeDataType>
  domEvent?: T
}

export interface NodeDragEventParams<TreeDataType extends BasicDataNode = DataNode, T = HTMLElement> {
  event: DragEvent
  node: EventDataNode<TreeDataType>
  domEvent?: T
}
...
export const UnstableContextKey: InjectionKey<{ nodeDisabled?: (n: DataNode) => boolean }> = Symbol(
  'UnstableTreeContext',
)
