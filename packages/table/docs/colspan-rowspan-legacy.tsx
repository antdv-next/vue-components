import type { ColumnsType, RenderedCell } from '../src'
...
const columns: ColumnsType<RecordType> = [
  {
    ...
    render(o, _row, index) {
      ...
      if (index === 4) {
        obj.props = { ...obj.props, colSpan: 2 }
      }
      if (index === 5) {
        obj.props = { ...obj.props, colSpan: 6 }
      }
      return obj
    },
  },
  ...
  },
  {
    ...
    render(o, _row, index) {
      ...
      if (index === 0) {
        obj.props = { ...obj.props, rowSpan: 2 }
      }
      if (index === 1 || index === 5) {
        obj.props = { ...obj.props, rowSpan: 0 }
      }
