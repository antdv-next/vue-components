  ...
  return () => (
    <div style={{ width: '800px' }}>
      ...
      <label>
        <input
          type="checkbox"
          checked={stickyTop.value}
          onChange={() => {
            stickyTop.value = !stickyTop.value
          }}
        />
        Sticky Top
      </label>
      ...
      <Table
        ...
        scroll={{ x: 1200, y: sticky.value ? undefined : 800 }}
        data={data}
        summary={() => (
          <Summary fixed={stickyTop.value ? 'top' : 'bottom'}>
            <SummaryRow>
              <SummaryCell index={0} />
              <SummaryCell index={1} colSpan={2}>
                Summary
              </SummaryCell>
              <SummaryCell index={3} colSpan={8}>
                Content
              </SummaryCell>
              <SummaryCell index={11} colSpan={2}>
                Right
              </SummaryCell>
            </SummaryRow>
          </Summary>
