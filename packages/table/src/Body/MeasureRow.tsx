...
// Deep-clone the title vnode tree so the measure-row copy doesn't share refs
// with the real header (fixes the sorter-page bug from da584d2). Hoisted out
// of setup so the function isn't recreated on every render.
