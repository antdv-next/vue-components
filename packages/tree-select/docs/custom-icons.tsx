...
function getSvg(path: string, iStyle: any = {}, style: any = {}) {
  return (
    <i style={iStyle}>
      <svg
...
export default defineComponent({
  name: 'TreeSelectCustomIconsDemo',
  setup() {
    return () => (
      <div class="custom-icon-demo" style={{ margin: '20px' }}>
        <h2>Single</h2>
        <TreeSelect
          ...
          style={{ width: '300px' }}
          popupStyle={{ maxHeight: '200px', overflow: 'auto', zIndex: 1500 }}
          showSearch
          allowClear
          {...iconProps as any}
        />

        <h2 style={{ marginTop: '20px' }}>Multiple</h2>
        <TreeSelect
          treeData={gData as any}
          multiple
          placeholder={<span>Please Select</span>}
