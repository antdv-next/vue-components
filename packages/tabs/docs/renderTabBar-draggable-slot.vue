...
// Use `DefaultTabBar`'s `default` slot to receive each internal tab `node`.
function renderTabBar(props: Record<string, any>, DefaultTabBar: any) {
  return h(DefaultTabBar, props, {
    default: (node: any) => h(DragTabWrapper, {
      node,
