...
export function fillFieldNames(fieldNames: FieldNames | undefined, childrenAsData: boolean): Required<FieldNames> {
 ...
 */
export function injectPropsWithOption<T extends object>(option: T | undefined): T | undefined {
  if (!option) {
    return option
  }
